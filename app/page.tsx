      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: entered ? 1 : 0 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="bg-white overflow-x-hidden">
        ...
        {/* <section id="about" className="mx-auto max-w-[1280px] px-4 py-12 sm:px-6 sm:py-16 md:px-8 md:py-24">
          <div className="grid items-center gap-8 sm:gap-10 md:grid-cols-2 md:gap-16">
            ...
            <div className="order-1 md:order-2">
              ...
              <Reveal delay={0.3} className="mt-4 sm:mt-6"><Link href="/about" className="inline-flex items-center gap-1 text-[11px] tracking-[0.14em] text-[#2D4A22] underline decoration-[#2D4A22]/20 underline-offset-4">{t.homeCommon.viewMore} <ArrowRight className="h-3 w-3" /></Link></Reveal>
            </div>
          </div>
        </section>
        ...
        <section id="choco" className="bg-white">
          <div className="mx-auto max-w-[1280px] px-4 py-12 sm:px-6 sm:py-16 md:px-8 md:py-20">
            ...
            <div className="mt-6 text-center"><Link href="/products?cat=choco" className="inline-flex items-center gap-1 text-[11px] tracking-[0.14em] text-[#2D4A22] underline">{t.homeCommon.viewAllProducts} <ArrowRight className="h-3 w-3" /></Link></div>
          </div>
        </section>
