...
export type OfficialPartner = { id: string; name: string; description: string; image: string; background: string; images?: string[]; color?: string; order?: number; isPublished: boolean; brandIds?: string[]; link?: string };
...
export const SEED_OFFICIAL_PARTNERS: OfficialPartner[] = [
  ...
  { id: "afya", name: "Afya", description: "Bubuk teh hijau premium dengan warna cerah dan rasa khas jepang.", image: "https://images.unsplash.com/photo-1536256263959-770b48d82b0a?w=600&q=80", background: "https://images.unsplash.com/photo-1536256263959-770b48d82b0a?w=1200&q=80", order: 1, isPublished: true },
