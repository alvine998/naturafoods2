...
export type Edu = { id: string; title: string; desc: string; duration: string; level: string; img: string };
export type Innovation = { id: string; title: string; desc: string; tag: string; img: string };
...
export const SEED_EDU: Edu[] = [
  { id: "barista-matcha", title: "Barista Matcha Essentials", desc: "Whisking, dosing (4g/70ml), latte dial-in & milk pairing.", duration: "1 day · Jakarta", level: "Beginner", img: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=700&q=80" },
  { id: "choco-pastry", title: "Choco Pastry Lab", desc: "Ganache, tempering & moulding for bakery and HORECA.", duration: "2 days · Surabaya", level: "Intermediate", img: "https://images.unsplash.com/photo-1551024506-0bccd828d307?w=700&q=80" },
  { id: "menu-costing", title: "Menu Costing Workshop", desc: "Cost-per-serve, waste and pricing for owners.", duration: "Half day · Online", level: "All levels", img: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=700&q=80" },
];

export const SEED_INNOVATION: Innovation[] = [
  { id: "single-origin-nusantara", title: "Nusantara Single-Origin", desc: "Estate cacao from Sulawesi — ferment & roast trials with Belgian partners.", tag: "R&D · 2026", img: "https://images.unsplash.com/photo-1610611424854-5e07032143d8?w=700&q=80" },
  { id: "low-sugar-couverture", title: "Low-Sugar Couverture", desc: "30% less sugar, same temper — pilot with 12 cafés.", tag: "Pilot", img: "https://images.unsplash.com/photo-1511381939415-e44015466834?w=700&q=80" },
  { id: "nitrogen-matcha", title: "Nitrogen-Sealed Retail Packs", desc: "500g matcha bricks with 12-month colour lock.", tag: "Packaging", img: "https://images.unsplash.com/photo-1564890369478-c89ca64c94ea?w=700&q=80" },
];
