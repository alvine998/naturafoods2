...
const dict: Record<Locale, Dict> = {
  ...
  id: {
    ...
    admin: { loginTitle: "Login Admin", user: "Username", pass: "Password", signIn: "Masuk", hint: "Demo: admin / admin123", invalid: "Kredensial salah.", dashTitle: "Dashboard CMS", logout: "Keluar", tabs: ["Produk", "Artikel", "Edukasi", "Inovasi", "Karir", "Inquiry", "Pengguna"], add: "Tambah", edit: "Edit", delete: "Hapus", save: "Simpan", cancel: "Batal", reset: "Reset ke seed", resetConfirm: "Reset semua data ke seed? Tidak bisa dibatalkan.", noData: "Tidak ada data.", users: { title: "Pengguna", addUser: "Tambah pengguna", username: "Username", password: "Password", newPassword: "Password baru", create: "Buat", remove: "Hapus", changePass: "Ganti password", you: "kamu", exists: "Username sudah ada.", lastUser: "Tidak bisa hapus user terakhir.", selfDelete: "Tidak bisa hapus diri sendiri." } },
  },
  zh: {
    ...
    admin: { loginTitle: "管理员登录", user: "用户名", pass: "密码", signIn: "登录", hint: "演示：admin / admin123", invalid: "账号或密码错误。", dashTitle: "管理后台", logout: "退出", tabs: ["产品", "文章", "教育", "创新", "招聘", "咨询", "用户"], add: "新增", edit: "编辑", delete: "删除", save: "保存", cancel: "取消", reset: "重置为初始数据", resetConfirm: "确定重置所有数据？此操作不可撤销。", noData: "暂无数据。", users: { title: "用户", addUser: "添加用户", username: "用户名", password: "密码", newPassword: "新密码", create: "创建", remove: "删除", changePass: "更新密码", you: "你", exists: "用户名已存在。", lastUser: "不能删除最后一个用户。", selfDelete: "不能删除自己。" } },
  },
};
