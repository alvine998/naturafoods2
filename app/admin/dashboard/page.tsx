...
export default function DashboardPage() {
  ...
  const links = [
    ...
    { href: "/admin/master-brands", label: a.tabs[2], c: counts[2], sub: "brands" },
    { href: "/admin/home-brands", label: a.tabs[3], c: counts[3], sub: "home brands" },
    { href: "/admin/official-partners", label: a.tabs[4], c: counts[4], sub: "partners" },
    { href: "/admin/articles", label: a.tabs[5], c: counts[5], sub: "published" },
    { href: "/admin/education", label: a.tabs[6], c: counts[6], sub: "classes" },
    { href: "/admin/innovation", label: a.tabs[7], c: counts[7], sub: "pilots" },
    { href: "/admin/careers", label: a.tabs[8], c: counts[8], sub: "open roles" },
    { href: "/admin/inquiries", label: a.tabs[9], c: counts[9], sub: "leads" },
    { href: "/admin/users", label: a.tabs[10], c: counts[10], sub: "users" },
    { href: "/admin/assistant", label: a.tabs[11], c: counts[11], sub: "fine-tuning" },
    { href: "/admin/content", label: (a.tabs as unknown as string[])[12] ?? "Content", c: counts[12], sub: "wording" },
    { href: "/admin/sales", label: (a.tabs as unknown as string[])[13] ?? "Sales", c: counts[13], sub: "contacts" },
    { href: "/admin/social-media", label: (a.tabs as unknown as string[])[14] ?? "Social Media", c: counts[14] ?? 0, sub: "social channels" },
    { href: "/admin/about", label: (a.tabs as unknown as string[])[15] ?? "About", c: counts[15] ?? 0, sub: "page content" },
  ];
  return (
