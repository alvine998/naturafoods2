    ...
    <div className="min-h-screen bg-[#FFFCF2] flex">
      ...
      <div className="hidden lg:flex w-[46%] shrink-0 flex-col justify-between bg-[#2D4A22] p-10 text-white">
        ...
        <div>
          ...
          <p className="mt-4 max-w-[36ch] text-[13px] leading-6 text-white/70">Products, articles, education, innovation, careers & inquiries — all in one place. Secure local session.</p>
        </div>
